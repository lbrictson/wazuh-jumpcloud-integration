...
wget https://github.com/lbrictson/wazuh-jumpcloud-integration/releases/download/0.0.2/wazuh-jumpcloud-integration -O /opt/jumpcloud/wazuh-jumpcloud-integration
